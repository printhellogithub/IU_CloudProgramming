...
from lambda.vendor.botocore.docs.docstring import LazyLoadedDocstring

from lambda.vendor.boto3.docs.action import document_action, document_load_reload_action
from lambda.vendor.boto3.docs.attr import (
    document_attribute,
    document_identifier,
    document_reference,
)
from lambda.vendor.boto3.docs.collection import (
    document_batch_action,
    document_collection_method,
    document_collection_object,
)
from lambda.vendor.boto3.docs.subresource import document_sub_resource
from lambda.vendor.boto3.docs.waiter import document_resource_waiter
