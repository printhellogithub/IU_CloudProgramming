...
from lambda.vendor.botocore.client import Config
...
import lambda.vendor.boto3 as boto3
import lambda.vendor.boto3.utils
from lambda.vendor.boto3.exceptions import ResourceNotExistsError, UnknownAPIVersionError
...
class Session:
    ...
    def __init__(
        ...
        if botocore_session is not None:
            ...
            self._session = lambda.vendor.botocore.session.get_session()
    ...
    def resource(
        ...
        service_context = lambda.vendor.boto3.utils.ServiceContext(
            service_name=service_name,
            service_model=service_model,
            resource_json_definitions=resource_model['resources'],
            service_waiter_model=lambda.vendor.boto3.utils.LazyLoadedWaiterModel(
    ...
    def _register_default_handlers(self):
        ...
        self._session.register(
            ...
            lambda.vendor.boto3.utils.lazy_call(
                'boto3.s3.inject.inject_s3_transfer_methods'
            ),
        )
        self._session.register(
            'creating-resource-class.s3.Bucket',
            lambda.vendor.boto3.utils.lazy_call('boto3.s3.inject.inject_bucket_methods'),
        )
        self._session.register(
            'creating-resource-class.s3.Object',
            lambda.vendor.boto3.utils.lazy_call('boto3.s3.inject.inject_object_methods'),
        )
        self._session.register(
        ...
        self._session.register(
            ...
            lambda.vendor.boto3.utils.lazy_call('boto3.ec2.createtags.inject_create_tags'),
        )
