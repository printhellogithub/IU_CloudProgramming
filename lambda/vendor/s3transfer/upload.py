...
from lambda.vendor.s3transfer.compat import readable, seekable
from lambda.vendor.s3transfer.constants import FULL_OBJECT_CHECKSUM_ARGS
from lambda.vendor.s3transfer.futures import IN_MEMORY_UPLOAD_TAG
from lambda.vendor.s3transfer.tasks import (
