...
from lambda.vendor.botocore.compat import six  # noqa: F401
from lambda.vendor.botocore.exceptions import IncompleteReadError, ResponseStreamingError
from lambda.vendor.botocore.vendored.requests.packages.urllib3.exceptions import (
    ReadTimeoutError,
)

import lambda.vendor.s3transfer.compat
from lambda.vendor.s3transfer.exceptions import RetriesExceededError, S3UploadFailedError
...
class OSUtils:
    ...
    def rename_file(self, current_filename, new_filename):
        lambda.vendor.s3transfer.compat.rename_file(current_filename, new_filename)
