...
from lambda.vendor.s3transfer.compat import MAXINT
from lambda.vendor.s3transfer.exceptions import CancelledError, TransferNotDoneError
from lambda.vendor.s3transfer.utils import FunctionContainer, TaskSemaphore

try:
    from lambda.vendor.botocore.context import get_context
except ImportError:
