...
from lambda.vendor.s3transfer.compat import MAXINT, BaseManager
from lambda.vendor.s3transfer.constants import ALLOWED_DOWNLOAD_ARGS, MB, PROCESS_USER_AGENT
from lambda.vendor.s3transfer.exceptions import CancelledError, RetriesExceededError
...
class ClientFactory:
    ...
    def create_client(self):
        ...
        session = lambda.vendor.botocore.session.Session()
