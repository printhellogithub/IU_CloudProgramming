...
from lambda
from lambda.vendor.botocore.retries import quota.vendor.botocore.configprovider import NEW_RETRIES_ENABLED
...
from lambda.vendor.botocore.retries import special
from lambda.vendor.botocore.retries.base import BaseRetryableChecker, BaseRetryBackoff
