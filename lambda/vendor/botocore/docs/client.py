...
from lambda.vendor.botocore.compat import OrderedDict
from lambda.vendor.botocore.docs.bcdoc.restdoc import DocumentStructure
from lambda.vendor.botocore.docs.example import ResponseExampleDocumenter
from lambda.vendor.botocore.docs.method import (
    document_custom_method,
    document_model_driven_method,
    get_instance_public_methods,
)
from lambda.vendor.botocore.docs.params import ResponseParamsDocumenter
from lambda.vendor.botocore.docs.sharedexample import document_shared_examples
from lambda.vendor.botocore.docs.utils import DocumentedShape, get_official_service_name
