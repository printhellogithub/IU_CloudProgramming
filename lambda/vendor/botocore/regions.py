...
from lambda.vendor.botocore.crt import CRT_SUPPORTED_AUTH_TYPES
from lambda.vendor.botocore.endpoint_provider import S3_UNREFERENCED_PARAMS, EndpointProvider
...
from lambda.vendor.botocore.utils import ensure_boolean, instance_cache
