...
import lambda.vendor.botocore as botocore
import lambda.vendor.botocore.auth
from lambda.vendor.botocore.awsrequest import create_request_object, prepare_request_dict
from lambda.vendor.botocore.compat import OrderedDict, get_current_datetime
...
from lambda.vendor.botocore.tokens import FrozenAuthToken
    ...
    * before-sign: Allows mutating the request before signing.
    ...
    def get_auth_instance(
        ...
        **kwargs,
        ...
        cls = lambda.vendor.botocore.auth.AUTH_TYPE_MAPS.get(signature_version)
        if cls is None:
...
class S3PostPresigner:
    ...
    def generate_presigned_post(
        ...
        policy['expiration'] = expire_date.strftime(lambda.vendor.botocore.auth.ISO8601)
