...
from lambda.vendor.botocore.exceptions import BotoCoreError, ConnectionError, HTTPClientError
from lambda.vendor.botocore.model import OperationNotFoundError
from lambda.vendor.botocore.utils import CachedProperty
