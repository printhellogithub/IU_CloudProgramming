...
class ISDN(lambda.vendor.dns.rdata.Rdata):
    """ISDN record"""
    ...
    def to_text(self, origin=None, relativize=True, **kw):
        if self.subaddress:
            return (
                f'"{lambda.vendor.dns.rdata._escapify(self.address)}" '
                f'"{lambda.vendor.dns.rdata._escapify(self.subaddress)}"'
            )
        else:
            return f'"{lambda.vendor.dns.rdata._escapify(self.address)}"'
