...
import lambda.vendor.dns.zonetypes


@lambda.vendor.dns.immutable.immutable
class ZONEMD(lambda.vendor.dns.rdata.Rdata):
    """ZONEMD record"""
    ...
    def __init__(self, rdclass, rdtype, serial, scheme, hash_algorithm, digest):
        ...
        self.scheme = lambda.vendor.dns.zonetypes.DigestScheme.make(scheme)
        self.hash_algorithm = lambda.vendor.dns.zonetypes.DigestHashAlgorithm.make(hash_algorithm)
        ...
        hasher = lambda.vendor.dns.zonetypes._digest_hashers.get(self.hash_algorithm)
    ...
    def to_text(self, origin=None, relativize=True, **kw):
        ...
        digest = lambda.vendor.dns.rdata._hexify(
