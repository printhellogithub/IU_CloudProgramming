...
class NAPTR(lambda.vendor.dns.rdata.Rdata):
    """NAPTR record"""
    ...
    def to_text(self, origin=None, relativize=True, **kw):
        ...
        return (
            ...
            f'"{lambda.vendor.dns.rdata._escapify(self.flags)}" '
            f'"{lambda.vendor.dns.rdata._escapify(self.service)}" '
            f'"{lambda.vendor.dns.rdata._escapify(self.regexp)}" '
            f"{replacement}"
        )
