...
from lambda.vendor.botocore.httpchecksum import DEFAULT_CHECKSUM_ALGORITHM, AwsChunkedWrapper
from lambda.vendor.botocore.utils import is_s3express_bucket

from lambda.vendor.s3transfer.compat import SOCKET_ERROR, fallocate, rename_file
from lambda.vendor.s3transfer.constants import FULL_OBJECT_CHECKSUM_ARGS
...
try:
    from lambda.vendor.botocore.utils import create_nested_client as create_client
except ImportError:
