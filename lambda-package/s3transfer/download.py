...
from lambda.vendor.botocore.exceptions import ClientError

from lambda.vendor.s3transfer.compat import seekable
from lambda.vendor.s3transfer.exceptions import (
    RetriesExceededError,
    S3DownloadFailedError,
    S3ValidationError,
)
from lambda.vendor.s3transfer.futures import IN_MEMORY_DOWNLOAD_TAG
from lambda.vendor.s3transfer.tasks import SubmissionTask, Task
