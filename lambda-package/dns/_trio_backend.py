...
def _maybe_timeout(timeout):
    if timeout is not None:
        ...
        return lambda.vendor.dns._asyncbackend.NullContext()
...
class DatagramSocket(lambda.vendor.dns._asyncbackend.DatagramSocket):
    ...
    async def recvfrom(self, size, timeout):
        ...
        raise lambda.vendor.dns.exception.Timeout(timeout=timeout)  # lgtm[py/unreachable-statement]
...
class StreamSocket(lambda.vendor.dns._asyncbackend.StreamSocket):
...
if lambda.vendor.dns._features.have("doh"):
    import httpcore
    ...
    from lambda.vendor.dns.query import _compute_times, _expiration_for_this_attempt, _remaining
    ...
    _HTTPTransport = lambda.vendor.dns._asyncbackend.NullTransport  # type: ignore


class Backend(lambda.vendor.dns._asyncbackend.Backend):
    def name(self):
        return "trio"
