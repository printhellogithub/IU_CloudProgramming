...
class TXTBase(lambda.vendor.dns.rdata.Rdata):
    ...
    def to_text(
        ...
        **kw: Dict[str, Any],
        ...
        for s in self.strings:
            txt += f'{prefix}"{lambda.vendor.dns.rdata._escapify(s)}"'
            prefix = " "
        return txt
    ...
    def from_text(
        ...
        for token in tok.get_remaining():
            ...
            if not (
                ...
                raise lambda.vendor.dns.exception.SyntaxError("expected a string")
