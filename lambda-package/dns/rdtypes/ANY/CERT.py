...
class CERT(lambda.vendor.dns.rdata.Rdata):
    """CERT record"""
    ...
    def to_text(self, origin=None, relativize=True, **kw):
        ...
        algorithm = lambda.vendor.dns.dnssectypes.Algorithm.to_text(self.algorithm)
        certificate = lambda.vendor.dns.rdata._base64ify(self.certificate, **kw)  # pyright: ignore
