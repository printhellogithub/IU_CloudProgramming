...
from lambda.vendor.dns.quic._common import (
    QUIC_MAX_DATAGRAM,
    AsyncQuicConnection,
    AsyncQuicManager,
    BaseQuicStream,
...
class AsyncioQuicConnection(AsyncQuicConnection):
    ...
    async def _receiver(self):
        try:
            af = lambda.vendor.dns.inet.af_for_address(self._address)
            backend = lambda.vendor.dns.asyncbackend.get_backend("asyncio")
