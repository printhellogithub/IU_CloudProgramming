...
from lambda.vendor.dns.query import (
    BadResponse,
    HTTPVersion,
    NoDOH,
    NoDOQ,
...
# for brevity
_lltuple = lambda.vendor.dns.inet.low_level_address_tuple
...
def _maybe_get_resolver(
    ...
    if resolver is None:
        ...
        import lambda.vendor.dns.asyncresolver

        resolver = lambda.vendor.dns.asyncresolver.Resolver()
    return resolver
