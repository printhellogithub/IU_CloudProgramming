...
from lambda.vendor.botocore import retryhandler.vendor.botocore as botocore
import lambda.vendor.botocore.auth
from lambda.vendor.botocore import (
    utils,
)
from lambda.vendor.botocore.args import ClientConfigString
...
from lambda.vendor.botocore.docs.utils import (
    AppendParamDocumentation,
    AutoPopulatedParam,
    DocumentModifiedShape,
    HideParamFromOperations,
)
from lambda.vendor.botocore.endpoint_provider import VALID_HOST_LABEL_RE
...
from lambda.vendor.botocore.regions import EndpointResolverBuiltins
from lambda.vendor.botocore.serialize import TIMESTAMP_PRECISION_MILLISECOND
from lambda.vendor.botocore.signers import (
    add_dsql_generate_db_auth_token_methods,
    add_generate_db_auth_token,
    add_generate_presigned_post,
    add_generate_presigned_url,
)
from lambda.vendor.botocore.useragent import register_feature_id
...
def _set_auth_scheme_preference_signer(context, signing_name, **kwargs):
    ...
    if (
        ...
        resolved = lambda.vendor.botocore.auth.resolve_auth_scheme_preference(
