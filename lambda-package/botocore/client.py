...
from lambda
from lambda.vendor.botocore.retries import adaptive.vendor.botocore import (
    waiter,
)
from lambda.vendor.botocore.args import ClientArgsCreator
from lambda.vendor.botocore.auth import (
    AUTH_TYPE_MAPS,
    resolve_auth_scheme_preference,
    resolve_auth_type,
)
from lambda.vendor.botocore.awsrequest import prepare_request_dict
from lambda.vendor.botocore.compress import maybe_compress_request
from lambda.vendor.botocore.config import Config
from lambda.vendor.botocore.context import with_current_context
from lambda.vendor.botocore.credentials import RefreshableCredentials
from lambda.vendor.botocore.discovery import (
    EndpointDiscoveryHandler,
    EndpointDiscoveryManager,
    block_endpoint_discovery_required_operations,
)
from lambda.vendor.botocore.docs.docstring import ClientMethodDocstring, PaginatorDocstring
...
from lambda.vendor.botocore.history import get_global_history_recorder
from lambda.vendor.botocore.hooks import first_non_none_response
from lambda.vendor.botocore.httpchecksum import (
    apply_request_checksum,
    resolve_checksum_context,
)
from lambda.vendor.botocore.model import ServiceModel
from lambda.vendor.botocore.paginate import Paginator
from lambda.vendor.botocore.retries import standard
...
from lambda.vendor.botocore import UNSIGNED, xform_name
