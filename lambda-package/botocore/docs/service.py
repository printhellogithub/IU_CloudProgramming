...
from lambda.vendor.botocore.docs.client import (
    ClientContextParamsDocumenter,
    ClientDocumenter,
    ClientExceptionsDocumenter,
)
from lambda.vendor.botocore.docs.paginator import PaginatorDocumenter
from lambda.vendor.botocore.docs.waiter import WaiterDocumenter
