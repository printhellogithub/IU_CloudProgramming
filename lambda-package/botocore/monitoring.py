...
from lambda.vendor.botocore.compat import ensure_bytes, ensure_unicode, urlparse
from lambda.vendor.botocore.retryhandler import EXCEPTION_MAP as RETRYABLE_EXCEPTIONS
