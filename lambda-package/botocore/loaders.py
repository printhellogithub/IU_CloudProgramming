...
from lambda.vendor.botocore import BOTOCORE_ROOT
from lambda.vendor.botocore.compat import HAS_GZIP, OrderedDict, json
from lambda.vendor.botocore.exceptions import DataNotFoundError, UnknownServiceError
from lambda.vendor.botocore.utils import deep_merge
