...
from lambda.vendor.botocore.compat import HAS_CRT
from lambda.vendor.botocore.exceptions import ClientError, MissingDependencyException
from lambda.vendor.s3transfer.exceptions import (
    RetriesExceededError as S3TransferRetriesExceededError,
)
from lambda.vendor.s3transfer.futures import NonThreadedExecutor
from lambda.vendor.s3transfer.manager import TransferConfig as S3TransferConfig
from lambda.vendor.s3transfer.manager import TransferManager
from lambda.vendor.s3transfer.subscribers import BaseSubscriber
from lambda.vendor.s3transfer.utils import OSUtils

import lambda.vendor.boto3.s3.constants as constants
from lambda.vendor.boto3.compat import TRANSFER_CONFIG_SUPPORTS_CRT
from lambda.vendor.boto3.exceptions import (
...
if HAS_CRT:
    ...
    from lambda.vendor.boto3.crt import create_crt_transfer_manager
