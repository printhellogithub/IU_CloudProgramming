...
from lambda.vendor.botocore import xform_name
from lambda.vendor.botocore.docs.bcdoc.restdoc import DocumentStructure
from lambda.vendor.botocore.docs.utils import get_official_service_name

from lambda.vendor.boto3.docs.action import ActionDocumenter
from lambda.vendor.boto3.docs.attr import (
    document_attribute,
    document_identifier,
    document_reference,
)
from lambda.vendor.boto3.docs.base import BaseDocumenter
from lambda.vendor.boto3.docs.collection import CollectionDocumenter
from lambda.vendor.boto3.docs.subresource import SubResourceDocumenter
from lambda.vendor.boto3.docs.utils import (
    add_resource_type_overview,
    get_identifier_args_for_signature,
    get_identifier_description,
    get_identifier_values_for_example,
)
from lambda.vendor.boto3.docs.waiter import WaiterResourceDocumenter
