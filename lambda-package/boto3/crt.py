...
from lambda.vendor.botocore.session import Session
from lambda.vendor.s3transfer.crt import (
...
from lambda.vendor.boto3.exceptions import InvalidCrtTransferConfigError
from lambda.vendor.boto3.s3.constants import CRT_TRANSFER_CLIENT
...
def compare_identity(boto3_creds, crt_s3_creds):
    ...
    except lambda.vendor.botocore.exceptions.NoCredentialsError:
        return False
